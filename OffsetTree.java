    ...
    private void sepToOffset()
    {
        ...
        if (nKids > 0)
        {
            ...
            int rootOffset = (nKids % 2 == 0)
                ? (((OffsetTree)kid(nKids / 2 - 1)).offset + ((OffsetTree)kid(nKids / 2)).offset) / 2
                 ...
                 contourN++, startKidN = (nKids1 - 1), kidNInc = -1)
            {
                ...
                for (int i = 1; i < h; i++)
                {
                    ...
                    isChanged |= updateContour(contours[contourN], i,
                        kid.offset + kid.contours[contourN][i - 1]);
                } /* for (int i= 1; i < h; i++) */
            }     /* for (contourN= LEFT, ...) */
        }         /* if (nKids1 > 0) */
        return isChanged;
   ...
   */
    private int leftSep(OffsetTree kid)
    {
        ...
        { //for each level of this.
            ...
            if (kidOffset - tOffset < MIN_SEP)
            { //move kid to the right.
   ...
   */
    ...
    static public void main(String args[])
    {
        ...
        if (false)
        {
            ...
            tAssgn.addKid(new OffsetTree("a"));
            tAssgn.addKid(new OffsetTree(":="));
            ...
            OffsetTree x = new OffsetTree("stmts",
