...
class SimpCompRecDescent extends RecParser
{
    ...
    protected final void parse() throws ParseException, ParseResetException
    {
        ...
        do
        {
            call((NonTerm)prgSyms.get("program"), ruleN, 175);
            program();
        } while (false);
        do
        {
    ...
    private void program() throws ParseException, ParseResetException
    {
        ...
        do
        {
            call((NonTerm)prgSyms.get("stmts"), ruleN, 182);
            stmts();
        } while (false);
    }
    ...
    private void stmts() throws ParseException, ParseResetException
    {
        ...
        do
        {
            call((NonTerm)prgSyms.get("assgnStmt"), ruleN, 188);
            assgnStmt();
        } while (false);
        do
        {
            call((NonTerm)prgSyms.get("stmtsRest"), ruleN, 189);
            stmtsRest();
        } while (false);
        do
        {
    ...
    private void stmtsRest() throws ParseException, ParseResetException
    {
        if (tok.getTokNum() == ';')
        {
            ...
            do
            {
                match((Terminal)prgSyms.get("';'"), ruleN, 197);
            } while (false);
            do
            {
                call((NonTerm)prgSyms.get("stmts"), ruleN, 198);
                stmts();
            } while (false);
            do
            {
    ...
    private void assgnStmt() throws ParseException, ParseResetException
    {
        ...
        do
        {
            match((Terminal)prgSyms.get("ID"), ruleN, 210);
        } while (false);
        do
        {
            match((Terminal)prgSyms.get("ASSGN"), ruleN, 211);
        } while (false);
        do
        {
            call((NonTerm)prgSyms.get("expr"), ruleN, 212);
            expr();
        } while (false);
        do
        {
    ...
    private void expr() throws ParseException, ParseResetException
    {
        ...
        do
        {
            call((NonTerm)prgSyms.get("term"), ruleN, 219);
            term();
        } while (false);
        do
        {
            call((NonTerm)prgSyms.get("exprRest"), ruleN, 220);
            exprRest();
        } while (false);
        do
        {
    ...
    private void exprRest() throws ParseException, ParseResetException
    {
        if (tok.getTokNum() == '+')
        {
            ...
            do
            {
                match((Terminal)prgSyms.get("'+'"), ruleN, 228);
            } while (false);
            do
            {
                call((NonTerm)prgSyms.get("term"), ruleN, 229);
                term();
            } while (false);
            do
            {
                call((NonTerm)prgSyms.get("exprRest"), ruleN, 230);
                exprRest();
            } while (false);
            do
            {
        ...
        else if (tok.getTokNum() == '-')
        {
            ...
            do
            {
                match((Terminal)prgSyms.get("'-'"), ruleN, 235);
            } while (false);
            do
            {
                call((NonTerm)prgSyms.get("term"), ruleN, 236);
                term();
            } while (false);
            do
            {
                call((NonTerm)prgSyms.get("exprRest"), ruleN, 237);
                exprRest();
            } while (false);
            do
            {
    ...
    private void term() throws ParseException, ParseResetException
    {
        ...
        do
        {
            call((NonTerm)prgSyms.get("factor"), ruleN, 249);
            factor();
        } while (false);
        do
        {
            call((NonTerm)prgSyms.get("termRest"), ruleN, 250);
            termRest();
        } while (false);
        do
        {
    ...
    private void termRest() throws ParseException, ParseResetException
    {
        if (tok.getTokNum() == '*')
        {
            ...
            do
            {
                match((Terminal)prgSyms.get("'*'"), ruleN, 258);
            } while (false);
            do
            {
                call((NonTerm)prgSyms.get("factor"), ruleN, 259);
                factor();
            } while (false);
            do
            {
                call((NonTerm)prgSyms.get("termRest"), ruleN, 260);
                termRest();
            } while (false);
            do
            {
        ...
        else if (tok.getTokNum() == '/')
        {
            ...
            do
            {
                match((Terminal)prgSyms.get("'/'"), ruleN, 265);
            } while (false);
            do
            {
                call((NonTerm)prgSyms.get("factor"), ruleN, 266);
                factor();
            } while (false);
            do
            {
                call((NonTerm)prgSyms.get("termRest"), ruleN, 267);
                termRest();
            } while (false);
            do
            {
        ...
        else if (tok.getTokNum() == SimpCompScanner.DIV_TOK)
        {
            ...
            do
            {
                match((Terminal)prgSyms.get("DIV"), ruleN, 272);
            } while (false);
            do
            {
                call((NonTerm)prgSyms.get("factor"), ruleN, 273);
                factor();
            } while (false);
            do
            {
                call((NonTerm)prgSyms.get("termRest"), ruleN, 274);
                termRest();
            } while (false);
            do
            {
        ...
        else if (tok.getTokNum() == SimpCompScanner.MOD_TOK)
        {
            ...
            do
            {
                match((Terminal)prgSyms.get("MOD"), ruleN, 279);
            } while (false);
            do
            {
                call((NonTerm)prgSyms.get("factor"), ruleN, 280);
                factor();
            } while (false);
            do
            {
                call((NonTerm)prgSyms.get("termRest"), ruleN, 281);
                termRest();
            } while (false);
            do
            {
    ...
    private void factor() throws ParseException, ParseResetException
    {
        if (tok.getTokNum() == '(')
        {
            ...
            do
            {
                match((Terminal)prgSyms.get("'('"), ruleN, 294);
            } while (false);
            do
            {
                call((NonTerm)prgSyms.get("expr"), ruleN, 295);
                expr();
            } while (false);
            do
            {
                match((Terminal)prgSyms.get("')'"), ruleN, 296);
            } while (false);
            do
            {
                ret(ruleN, 297);
        ...
        else if (tok.getTokNum() == SimpCompScanner.ID_TOK)
        {
            ...
            do
            {
                match((Terminal)prgSyms.get("ID"), ruleN, 301);
            } while (false);
            do
            {
                ret(ruleN, 302);
        ...
        else
        {
            ...
            do
            {
                match((Terminal)prgSyms.get("NUM"), ruleN, 307);
            } while (false);
            do
            {
                ret(ruleN, 308);
