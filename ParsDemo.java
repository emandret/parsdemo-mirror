...
public class ParsDemo extends Applet implements Runnable
{
    ...
    public ParsDemo(String args[], int context)
    {
        ...
        {
            String alg = args[0];
            algorithm = alg.equals("Rec") ? REC_DESCENT_PARSER
    ...
    public void init()
    {
        ...
        if (context != CMD_LINE_CONTEXT)
        {
            ...
            if (alg != null)
            {
                algorithm = alg.equals("LL1Parser") ? LL_PARSER : alg.equals("SRParser") ? SR_PARSER : REC_DESCENT_PARSER;
            }
        }
        ...
        switch (algorithm)
        {
            case REC_DESCENT_PARSER:
            {
                ...
                parseDisplay = new ParseDisplay(treeCanvas, prgTableCanvas, traceCanvas, extFrame);
        ...
        runDelayScrollbar = new Scrollbar(Scrollbar.HORIZONTAL, 10, 1, 7, 13);
        updateRunDelay();
    ...
    public boolean action(Event evt, Object arg)
    {
        if (evt.target == updateButton)
        {
            ...
            {
                updateButton.setLabel("ignore");
                extFrame.setUpdate(true);
            }
            else
            {
