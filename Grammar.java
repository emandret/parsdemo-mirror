...
abstract class Grammar
{
    ...
    protected Terminal terminal(String name, int tok)
    {
        ...
        {
            throw new InternalError("non-terminal symbol " + name + "used as terminal");
        }
        return (Terminal)sym;
    }
    ...
    protected NonTerm nonTerm(String name)
    {
        ...
        {
            throw new InternalError("terminal symbol " + name + "used as non-terminal");
        }
        if (startSym == null)
